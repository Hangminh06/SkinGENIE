...
def resource_path(rel_path: str) -> str:
    """
    Trả về đường dẫn tuyệt đối tới file/directory đã được đóng gói.
    Dùng được khi chạy bằng Python bình thường **và** khi đã đóng gói với PyInstaller.
    """
...
def play_background_music():
    pygame.mixer.init()
    pygame.mixer.music.load(resource_path("BTS 방탄소년단 소우주Mikrokosmos Orchestral cover.mp3"))  # Đường dẫn tới file nhạc của bạn
...
# Load YOLO model
model = YOLO(resource_path("runs/segment/train2/weights/best.pt"))

# Đọc file CSV
df = pd.read_csv(resource_path("data/AI Final - Trang tính1.csv"))
...
# Load the CSV file
csv_file = resource_path("data/Skincare_products2.csv")
...
products_df.to_csv(resource_path("data/Skincare_products_cleaned.csv"), index=False, sep=';')
...
def main_screen():
    ...
    bg_image = Image.open(resource_path("images/SKINGENIE.png"))
    ...
    our_team_img = Image.open(resource_path("images/our_team.png"))
    our_team_photo = ImageTk.PhotoImage(our_team_img)
    our_team_label = tk.Label(root, image=our_team_photo, bg="#ab73c0", cursor="hand2")
    ...
    start_hover_img = Image.open(resource_path("images/start_hover.png"))
    start_photo = ImageTk.PhotoImage(start_img)
    start_hover_photo = ImageTk.PhotoImage(start_hover_img)
    start_label = tk.Label(root, image=start_photo, bg="white", cursor="hand2")
...
def our_team_screen():
    ...
    # Tải ảnh làm background
    bg_image = Image.open(resource_path("images/team.png"))
    bg_image = bg_image.resize((1400, 800))  # Resize cho phù hợp với màn hình
    bg_image_tk = ImageTk.PhotoImage(bg_image)
    ...
    # Nút "Home"
    home_img = Image.open(resource_path("images/home.png"))  # Bạn cần có ảnh mũi tên/quay về
    home_img = home_img.resize((60, 60), Image.Resampling.LANCZOS)
    home_photo = ImageTk.PhotoImage(home_img)
    home_label = tk.Label(root, image=home_photo, bg="#ab73c0", cursor="hand2")
...
def skin_check_screen():
    ...
    # Tải ảnh làm background
    bg_image = Image.open(resource_path("images/skin_check.png"))
    bg_image = bg_image.resize((1400, 800))  # Resize cho phù hợp với màn hình
    bg_image_tk = ImageTk.PhotoImage(bg_image)
    ...
    # Nút "Upload image"
    upload_image_img = Image.open(resource_path("images/upload_image.png"))
    ...
    upload_image_label = tk.Label(root, image=upload_image_photo, bg="white", cursor="hand2")
    ...
    # Nút "Take picture"
    take_picture_img = Image.open(resource_path("images/take_picture.png"))
    ...
    take_picture_label = tk.Label(root, image=take_picture_photo, bg="white", cursor="hand2")
...
def preview_screen(image_path):
    ...
    # Tải ảnh làm background
    bg_image = Image.open(resource_path("images/preview.png"))
    bg_image = bg_image.resize((1400, 800))  # Resize cho phù hợp với màn hình
    bg_image_tk = ImageTk.PhotoImage(bg_image)
    ...
    if image_path:
        try:
            user_image = Image.open(image_path if os.path.exists(image_path) else resource_path(image_path))
    ...
    back_label = tk.Label(root, image=back_photo, bg="#ab73c0", cursor="hand2")
    ...
    upload_image_again_img = Image.open(resource_path("images/upload_image_again.png"))
    ...
    upload_image_again_label = tk.Label(root, image=upload_image_again_photo, bg="white", cursor="hand2")
    ...
    take_picture_again_img = Image.open(resource_path("images/take_picture_again.png"))
    ...
    take_picture_again_label = tk.Label(root, image=take_picture_again_photo, bg="white", cursor="hand2")
    ...
    # Nút "Result"
    result_button_img = Image.open(resource_path("images/result_button.png"))
    ...
    result_button_label = tk.Label(root, image=result_button_photo, bg="white", cursor="hand2")
...
def result_screen():
    ...
    # --- Ảnh nền ---
    bg_image = Image.open(resource_path("images/result.png")).resize((1400, 800))
    bg_image_tk = ImageTk.PhotoImage(bg_image)
    bg_label = tk.Label(root, image=bg_image_tk)
    bg_label.place(relwidth=1, relheight=1)
    bg_label.image = bg_image_tk
    ...
    discover_img = Image.open(resource_path("images/discover.png"))
    discover_img = discover_img.resize((600, 135), Image.Resampling.LANCZOS)
    discover_photo = ImageTk.PhotoImage(discover_img)
    discover_label = tk.Label(root, image=discover_photo, bg="#fcf6d0", cursor="hand2")
...
def skincare_screen():
    ...
    # --- Ảnh nền ---
    bg_image = Image.open(resource_path("images/Skincare.png")).resize((1400, 800))
    bg_image_tk = ImageTk.PhotoImage(bg_image)
    bg_label = tk.Label(root, image=bg_image_tk)
    bg_label.place(relwidth=1, relheight=1)
    bg_label.image = bg_image_tk
    ...
    # --- Nút "Home" ---
    home_img = Image.open(resource_path("images/home.png")).resize((60, 60), Image.Resampling.LANCZOS)
    home_photo = ImageTk.PhotoImage(home_img)
    home_label = tk.Label(root, image=home_photo, bg="#ab73c0", cursor="hand2")
    home_label.place(x=7, y=734)
    home_label.image = home_photo
    ...
    # --- Nút "Back" ---
    back_img = Image.open(resource_path("images/back.png")).resize((70, 50), Image.Resampling.LANCZOS)
    back_photo = ImageTk.PhotoImage(back_img)
    back_label = tk.Label(root, image=back_photo, bg="#ab73c0", cursor="hand2")
    back_label.place(x=1320, y=740)
    back_label.image = back_photo
    ...
    # --- Nút "Next" ---
    next_img = Image.open(resource_path("images/next.png")).resize((70, 70), Image.Resampling.LANCZOS)
    next_photo = ImageTk.PhotoImage(next_img)
    next_label = tk.Label(root, image=next_photo, bg="#3b467e", cursor="hand2")
    next_label.place(x=710, y=640)
    next_label.image = next_photo
    next_label.bind("<Button-1>", lambda e: next_button())

    # --- Nút "Products" ---
    products_img = Image.open(resource_path("images/products.png")).resize((330, 85), Image.Resampling.LANCZOS)
    products_photo = ImageTk.PhotoImage(products_img)
    products_label = tk.Label(root, image=products_photo, bg="white", cursor="hand2")
...
def next_skincare_screen():
    ...
    # --- Ảnh nền ---
    bg_image = Image.open(resource_path("images/Skincare (2).png")).resize((1400, 800))
    bg_image_tk = ImageTk.PhotoImage(bg_image)
    bg_label = tk.Label(root, image=bg_image_tk)
    bg_label.place(relwidth=1, relheight=1)
    bg_label.image = bg_image_tk
    ...
    # --- Nút "Return" ---
    return_img = Image.open(resource_path("images/return.png")).resize((70, 70), Image.Resampling.LANCZOS)
    return_photo = ImageTk.PhotoImage(return_img)
    return_label = tk.Label(root, image=return_photo, bg="#3b467e", cursor="hand2")
...
def skince_product_screen():
    ...
    # --- Ảnh nền ---
    bg_image = Image.open(resource_path("images/skince_product.png")).resize((1400, 800))
    bg_image_tk = ImageTk.PhotoImage(bg_image)
    bg_label = tk.Label(root, image=bg_image_tk)
    bg_label.place(relwidth=1, relheight=1)
    bg_label.image = bg_image_tk
    ...
    # --- Nút "Routine" ---
    routine_img = Image.open(resource_path("images/routine.png")).resize((290, 76), Image.Resampling.LANCZOS)
    routine_photo = ImageTk.PhotoImage(routine_img)
    routine_label = tk.Label(root, image=routine_photo, bg="white", cursor="hand2")
    ...
    info_img = Image.open(resource_path("images/info.png")).resize((40, 40), Image.Resampling.LANCZOS)
    info_photo = ImageTk.PhotoImage(info_img)
    info_label = tk.Label(root, image=info_photo, bg="#fcf6d0", cursor="hand2")
...
def skin_type_screen():
    ...
    # Tải ảnh làm background
    bg_image = Image.open(resource_path("images/skin_type.png"))
    bg_image = bg_image.resize((1400, 800))  # Resize cho phù hợp với màn hình
    bg_image_tk = ImageTk.PhotoImage(bg_image)
...
def clinic_screen():
    ...
    # Tải ảnh làm background
    bg_image = Image.open(resource_path("images/place.png"))
    bg_image = bg_image.resize((1400, 800))  # Resize cho phù hợp với màn hình
    bg_image_tk = ImageTk.PhotoImage(bg_image)
